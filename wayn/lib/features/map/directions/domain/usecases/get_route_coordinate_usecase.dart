...
class GetRouteCoordinatesUseCase {
  final DirectionsRepository repository;

  GetRouteCoordinatesUseCase(this.repository);

  Future<RouteCoordinates> execute(Point origin, Point destination) {
    return repository.getRouteCoordinates(origin, destination);
  }
}
